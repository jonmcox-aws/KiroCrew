...
class TestReactionsBelongToTheirOwnTier:
    ...
    def test_expressions_are_stripped_where_no_face_exists_to_move(self, record):
        """A picture and a pack have no eyes/mouth axis, and nothing renders the
        key on them -- so it is junk there, and junk is dropped, never refused."""
