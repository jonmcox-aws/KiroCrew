    ...
    def _resolve_prompt_templates(prompt: str, session_key: str) -> str:
        ...
        if verbosity == "ultra":
            ...
            verbosity_block = (
                ...
                "richest form this surface renders: a widget when your "
                "instructions carry an Inline Widgets section (load `widgets` "
                "first), else a mermaid fence, else a plain table. A picture "
                "holds labels of one to three words and numbers, never a "
                "sentence. If a sentence is needed, it goes under the picture, "
                "once.\n"
                ...
                "3. Cut check. Delete: preamble, what you did, why, options you "
                "rejected, caveats, offers. Keep: the answer; code, commands and "
                "paths verbatim; required formats ([OPTIONS:], diffs, PR links); "
                "one undo line for anything destructive; one risk line for "
                "anything touching security, data or spend.\n\n"
